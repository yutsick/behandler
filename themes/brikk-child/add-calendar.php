...
<div class="rz-submission-content ">
    ...
    <div class="rz-modal rz-modal-ready" data-id="modal-availability" data-signup="pass">
    <a href="#" class="rz-close">
        <i class="fas fa-times"></i>
    </a>
    <div class="rz-modal-heading rz--border rz-modal-title-bg">
        <h4 class="">Gå til kalenderen</h4>
    </div>
    ...
    <section class="rz-submission-step" data-id="fields" data-group="0">
            ...
            <section class="rz-submission-step" data-id="reservation">
                ...
                <div class="rz-grid">
                    ...
                    <div class="rz-form-group rz-field rz-col-12 rz-field-ready" data-type="repeater" data-storage="request" data-disabled="no" data-heading="Add Availability" data-id="time_availability">
