...
<div class="contain-registration">
    <div class="registration-imag h-100">
            ...
            <div class="u-columns col2-set" id="customer_login">
                ...
                <div class="u-column1 col-1">
                    ...
                    ?>
                            ...
                            <a href="/registration-user/" class="rz-button-accent w-100">
                                Søger efter behandling
                            </a>

                            <a href="/registration-doctor-in/" class="rz-button-white w-100">
                                Tilbyder behandling
                            </a>
