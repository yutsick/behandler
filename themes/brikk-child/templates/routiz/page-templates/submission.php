				...
				<?php if( $rz_submission->get_listing_types()->found_posts ): ?>
				    <?php if( $rz_submission->is_missing_type() ): ?>
						...
						<?php 
							...
							Rz()->the_template('routiz/submission/listing-type'); ?>

				    <?php else: ?>

					    <div class="rz-submission-content">
					        <?php
							Rz()->the_template('routiz/submission/steps'); ?>
					    </div>
		...
		<div class="brk--bottom">
			<?php if( $rz_submission->get_listing_types()->found_posts ): ?>
				...
				<div class="brk--cell brk--cell-next">
					<a href="#" class="rz-button rz-button-accent" id="cart"<?php echo is_user_logged_in() ? 'data-action="submission-continue"' : 'data-modal="signin"'; ?>>
